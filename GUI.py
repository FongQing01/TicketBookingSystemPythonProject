...
app.title('Online Tickets Booking')
...
def reservation(name, movie, quantity, price):
    ...
    frame = customtkinter.CTkFrame(app,bg_color='#18161D', fg_color='#292923', corner_radius=10, border_color='#0f0', border_width=2, width=200, height=130)
...
image1 = PhotoImage(file='popcorn.png')
image1_label = Label(app, image=image1,bg='#18161D')
image1_label.place(x=130, y=10)
...
name_entry = customtkinter.CTkEntry(app, font=font3, text_color='#000', fg_color='#fff', border_color='#000', border_width=2, width=160)
name_entry.place(x=290, y=300)

name_label = customtkinter.CTkLabel(app, font=font3, text='No. of Tickets: ', text_color='#fff', bg_color='#18161D')
name_label.place(x=122, y=350)
...
book_button = customtkinter.CTkButton(app, command=book, font=font3, text_color='#fff',text='Book Your Tickets', fg_color='#AA04A7', hover_color='#6D006B', bg_color='#18161D', cursor='hand2', corner_radius=15, width=200)
